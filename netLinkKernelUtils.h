...
#define MAX_PAYLOAD 1024 * 64

/*User defined NL MSG TYPES, should be > 16 */
#define NLMSG_GREET     20
#define MOVDIR64B_SUPPORTED     21
#define MOVDIR64B_EXECUTE       22
#define PCIE_TRANSACTION 23
#define FUZZING_CFG_SPACE 24
#define FUZZING_MMIO_SPACE 25
...
netlink_get_msg_type(__u16 nlmsg_type){
    ...
    switch(nlmsg_type){
        ...
        case NLMSG_GREET:
            return "NLMSG_GREET";
        case MOVDIR64B_SUPPORTED:
            return "MOVDIR64B_SUPPORTED";
        case MOVDIR64B_EXECUTE:
            return "MOVDIR64B_EXECUTE";
        case PCIE_TRANSACTION:
            return "PCIE_TRANSACTION";
        case FUZZING_CFG_SPACE:
            return "FUZZING_CFG_SPACE";
        case FUZZING_MMIO_SPACE:
            return "FUZZING_MMIO_SPACE";
        default:
